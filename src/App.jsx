/**
 * VA Studio Frontend — Organization Standalone
 *
 * This is a standalone version of the Organization template.
 * It renders the Organization template directly as the main interface.
 *
 * Routes:
 *   /  → Organization template (default)
 *
...
import TemplateApp from '../templates/organization/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (Organization Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
